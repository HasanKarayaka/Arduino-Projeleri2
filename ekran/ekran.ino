...
MCUFRIEND_kbv tft(A3, A2, A1, A0, A4);  //tft isimli bir nesne yaratıyoruz.

//RENKLERİ TANIMLIYORUZ
...
tft.setTextColor(WHITE,BLUE); //Metnin rengi ve metin arkaplanının rengi. Arkaplan rengi kısmını boş bırakırsanız saydam olur.
...
tft.drawRGBBitmap(85, 200, lotr, 64, 38); //Resim gösterme
